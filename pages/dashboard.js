...
export default function Dashboard() {
  ...
  useEffect(() => {
    if (status === 'unauthenticated') {
      router.push('/login'); // Send them to login if not signed in
    }
  }, [status, router]);
  ...
  // If not logged in, return null (waiting for redirect)
      ...
      <div className="grid">
        ...
        <div className="card">
          ...
          <form onSubmit={handleCreateEvent}>
            <input 
              placeholder="Event Title (e.g. Music Fest)" 
